    ...
    <section className="py-24 px-6 border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-white/5">
          {pillars.map((pillar) => (
            <div key={pillar.index} className="bg-[#0A0A0A] p-10 group hover:bg-[#0d0d0d] transition-colors flex flex-col">
              <span className="font-serif text-5xl text-gold/12 group-hover:text-gold/25 transition-colors block mb-6">
                {pillar.index}
              </span>
              ...
              <p className="text-gray-400 leading-relaxed text-sm flex-1">{pillar.description}</p>
